...
\begin{tabularx}{16cm}{l|X}
	...
	\hline
	ABHÄNGIGKEITEN: & FA-G \ref{Gaspatronen-Lippenstift}, FA-G \ref{Wanze und Ohrstoepsel}, FA-G \ref{Chicken Feed}, FA-G \ref{Geheimnis erhalten}  \\
\end{tabularx}
...
\begin{tabularx}{16cm}{l|X}
 ...
 Bei erfolgreicher Durchführung einer Bewegung muss dem Charakter am Zug die Anzahl der Bewegungspunkte um 1 reduziert werden. Bei nicht erfolgreicher Durchführung darf sich die Anzahl der Bewegungspunkte  nicht verändern.\\
	...
	\hline
	ABHÄNGIGKEITEN: & FA-G\ref{Charakter}, FA-G\ref{Felder}, FA-G\ref{Spielbrett}, FA-G\ref{Freies Feld}, \\
\end{tabularx}
...
\begin{tabularx}{16cm}{l|X}
	...
	\hline
	ABHÄNGIGKEITEN: & FA-G\ref{Bewegung durchfuehren}, FA-G \ref{Charakter-Position}, FA-G \ref{Felder}, FA-G \ref{Freies Feld} \\
\end{tabularx}
...
\begin{tabularx}{16cm}{l|X}
	...
	\hline
	ABHÄNGIGKEITEN: & FA-G\ref{Bewegung durchfuehren} \\
\end{tabularx}
